...
setupImageUpload('headerUpload', 'headerFile', 'headerPreviewImg', 'headerRemove', (data) => {
...
function renderPreview() {
  ...
  const salesConfNo = $('#salesConfNo').value || '—';
  ...
  const headerHTML = headerImageData
    ? `<div class="inv-header"><img src="${headerImageData}" class="inv-header-img" alt="Company Header"></div>`
    : `<div class="inv-header" style="padding: 20px; color: #999; font-style: italic;">[Company Header Image]</div>`;
  ...
  preview.innerHTML = `
    ...
    <div class="inv-meta-buyer">
      ...
      <div class="inv-meta">
        ...
        <span class="inv-meta-label">Sales Confirmation No.</span> <strong>${salesConfNo}</strong><br>
